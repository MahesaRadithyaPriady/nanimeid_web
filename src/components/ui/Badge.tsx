...
export const Badge: React.FC<BadgeProps> = ({
  ...
  const variants = {
    ...
    ongoing: "bg-green-500/10 text-green-600 dark:text-green-400 border border-green-500/20 px-2 py-0.5",
    ...
    rating: "bg-yellow-500/10 text-yellow-600 dark:text-yellow-400 border border-yellow-500/25 px-2 py-0.5"
  };
